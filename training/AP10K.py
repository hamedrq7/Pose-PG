...
class AP10KTrain(Train):
    """
    AP10KTrain class.

    Extension of the Train class for the AP10K dataset.
    """
    ...
    def __init__(self,
        ...
        """
        Initializes a new AP10KTrain object which extends the parent Train class.
        The initialization function calls the init function of the Train class.

        Args:
            exp_name (str):  experiment name.
            ds_train (AP10KDataset): train dataset.
            ds_val (AP10KDataset): validation dataset.
            ...
            device (torch.device): device to be used (default: cuda, if available).
                Default: None
        """
        super(AP10KTrain, self).__init__(
            exp_name=exp_name,
            ds_train=ds_train,
            ds_val=ds_val,
            epochs=epochs,
