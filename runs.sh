...
python scripts/train_sodef.py --num_workers 8 --model_c 50 --model_name poseresnet_sodef --pretrained_weight_path '/mnt/data/hossein/Hossein_workspace/nips_cetra/hamed/exps/AdvTraining_FAST_FGSM_RS_MIX_eps4_stepsize_2/20251109_1807/checkpoint_cln_best_mAP.pth' --batch_size 32 --log_path '../exps/tryingSODEF'
