...
python scripts/train_coco_imagenet_ood.py --epochs 3 --log_path '../exps/testin_ood/RawImageNet-aux_weight-0.001+1warmup' --aux_loss_weight 0.001 --pose_batch_size 16 --aux_batch_size 16 --weight_decay 0.0 --num_workers 4 --model_c 50 --image_resolution '(256, 192)' --model_name poseresnet_ood --pretrained_weight_path './downloads/standard_resnet50.pth'
