...
python scripts/test_crowdpose_zeroshot.py --model_c 50 --log_path '../exps/st_poseresnet' --pretrained_weight_path '../exps/UsingMyCustomDataset_AndOtherSetting_ST_R50_Sigma2/20251031_1656/checkpoint_best_mAP.pth' --model_name 'poseresnet' --exp_name 'testing_crowdpose_zeroshot' --num_workers 8 
python scripts/test_crowdpose_zeroshot.py --model_c 50 --log_path '../exps/fgsmtraining_poseresnet' --pretrained_weight_path '../exps/AdvTraining_FAST_FGSM_RS_MIX_eps4_stepsize_2/20251109_1807/checkpoint_cln_best_mAP.pth' --model_name 'poseresnet' --exp_name 'testing_crowdpose_zeroshot' --num_workers 8 
