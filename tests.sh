...
python scripts/test_coco.py --log_path '../exps/vitpose_small' --pretrained_weight_path './downloads/vitpose_small.pth' --model_name 'vitpose_small' --exp_name 'testpgd - val with gt boxes' --num_workers 8 
