...
from datasets.CustomDS.eval_utils import * 
from datasets.CustomDS.augmentaions import Compose

######## From mmpose\datasets\dataset_info.py  ########
import numpy as np
...
#####################################################################
### From mmpose\datasets\datasets\base\kpt_2d_sview_rgb_img_top_down_dataset.py 
class Kpt2dSviewRgbImgTopDownDataset(Dataset, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        self.flip_pairs = flip_pairs = self.ann_info['flip_pairs']
