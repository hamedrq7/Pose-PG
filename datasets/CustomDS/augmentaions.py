...
#### From mmpose\datasets\pipelines\loading.py
import cv2
...
class LoadImageFromFile:
    ...
    def __call__(self, results):
        ...
        img = cv2.imread(image_file, cv2.IMREAD_COLOR_RGB)
...
#### From mmpose\datasets\pipelines\top_down_transform.py
...
#### From mmpose\datasets\pipelines\shared_transform.py
...
### from https://github.com/open-mmlab/mmcv/blob/master/mmcv/parallel/data_container.py 
from typing import Callable, Type, Union
