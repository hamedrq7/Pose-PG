...
from training.COCO_ImageNet_OOD import COCO_ImageNet_OOD
...
def main(exp_name,
    ...
    aux_ds_train = get_imagenet_loaders(image_resolution=image_resolution, phase="train") # For testing the code
