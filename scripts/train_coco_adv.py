...
def main(exp_name,
    ...
    print(f'Attacker parameters: attack_type: {attack_type}, eps: {epsilon}, num_steps: {num_steps}, step_size: {step_size}, disable_rand_init: {disable_rand_init}')
    ...
    train = COCOAdv_Train(
        ...
        num_steps=num_steps,
        step_size=step_size,
        rand_init=not disable_rand_init,
        # mean = train_deleted_module.mean, 
        # std = train_deleted_module.std,  
    )
...
if __name__ == '__main__':
    ...
    # Adv Parameters
    parser.add_argument("--mix_st", "-u", help="mix standard input with adv during training", action="store_true")
    ...
    parser.add_argument("--disable_rand_init", "-u", help="disables random noise in adv generation during training", action="store_true")
